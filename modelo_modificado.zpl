...
#Variables
var y[C] binary;     #Si se abre la central j, y[j] = 1. Sino 0
var x[O*C] binary;   #Si la central operativa j abastece a la oficina i, x[i,j] = 1. Sino 0 
...
subto operaciones: forall <j> in C:            #Repetar la capacidad máxima de operaciones por hora que procesa una central
